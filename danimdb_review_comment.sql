...
CREATE TABLE `review_comment` (
  `RB_Comment_UQ` int(11) NOT NULL AUTO_INCREMENT COMMENT '번호 (PK)',
  `Review_Board` varchar(255) DEFAULT NULL,
  `User_ID` char(255) DEFAULT NULL,
  `Review__Contents` varchar(255) DEFAULT NULL,
  `Review_Date_Created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '등록일',
  `Review_Report` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`RB_Comment_UQ`)
