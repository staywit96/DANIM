...
CREATE TABLE `qna_comment` (
  `QNA_Comment_Unique_Number` int(11) NOT NULL,
  `QNA_Unique_Number` varchar(255) DEFAULT NULL,
  `QNA_Contents` varchar(255) DEFAULT NULL,
  `QNA_Date_Created` varchar(255) DEFAULT NULL,
  `QNA_Report` varchar(255) DEFAULT NULL
