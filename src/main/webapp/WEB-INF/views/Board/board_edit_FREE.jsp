...
<script>
	function backToViewF(){
		location.href="${contextPath}/board/viewf.do";
	}
		...
		<div class="board_write_wrap">
			<div class="board_write">
				<div class="title">
					<dl>
						<dt>제목</dt>
						<dd><input type="text" name="FB_Title" placeholder="제목 입력" value="글 제목이 들어갑니다.">${test.FB_Title}</dd>
					</dl>
				</div>	
				...
				<div class="cont">
					<textarea name="FB_Contents" type="text" placeholder="내용 입력">
${test.FB_Contents}
					</textarea>
			...
			<div class=bt_wrap>
				<input type="button" id="detailed" value="수정" onClick="backToViewF()"/>
