...
<script>
	function backToViewQ(){
		location.href="${contextPath}/board/viewq.do";
	}
		...
		<div class="board_write_wrap">
			<div class="board_write">
				<div class="title">
					<dl>
						<dt>제목</dt>
						<dd><input type="text" name="QNA_Title" placeholder="제목 입력" value="글 제목이 들어갑니다.">${test.QNA_Title}</dd>
					</dl>
				</div>	
				...
				<div class="info">
					<dl class="User_ID">
						<dt>글쓴이</dt>
						<dd><input type="text" name="User_ID" placeholder="글쓴이 입력" value="김아름"></dd>
					</dl>
				</div>	
				
				<div class="cont">
					<textarea placeholder="내용 입력" name="QNA_Contents" type="text">
${test.QNA_Contents}
					</textarea>
			...
			<div class=bt_wrap>
				<input type="button" id="detailed" value="수정" onClick="backToViewQ()"/>
